        ...
        add: function (e, data) {
            $("#submitFrm").css('pointer-events','none');
             // $('#contactform').attr('action','uploadcontact.php');
              $('#contact-frm').attr('action','upload.php?frm=contact');
               ...
               // upload by ajax
                var jqXHR = data.submit().done(function (result, textStatus, jqXHR) {
                     ...
                     var returnValue = JSON.parse(result);
                        ...
                        $('#contact-frm').attr('action','sendmail1.php');
    ...
    $('#hireuploadcontact').fileupload({
        ...
        add: function (e, data) {
            $("#submitHireDevFrm").css('pointer-events','none');
             // $('#contactform').attr('action','uploadcontact.php');
              $('#hire-developer-new-frm').attr('action','upload.php?frm=hireDeveloper');
               ...
               // upload by ajax
                var jqXHR = data.submit().done(function (result, textStatus, jqXHR) {
                     ...
                     var returnValue = JSON.parse(result);
                        ...
                        $('#hire-developer-new-frm').attr('action','sendmail1.php');
